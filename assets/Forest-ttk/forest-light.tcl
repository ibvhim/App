...
# Modified - 2023 ibvhim <ibrahim.shukoor@outlook.com>

# This modified pallette is supposed to be a calm and modernistic approach to a dark themes.
...
namespace eval ttk::theme::forest-light {
    ...
    ttk::style theme create forest-light -parent default -settings {
        ...
        ttk::style layout Quit.TButton {
            QuitButton.button -children {
                QuitButton.padding -children {
                    QuitButton.label -side left -expand true
                } 
            }
        }
        ...
        ttk::style element create AccentButton.button image \
            ...
            # QuitButton
        ttk::style configure Quit.TButton -padding {8 4 8 4} -width -10 -anchor center -foreground #eeeeee

        ttk::style element create QuitButton.button image \
            [list $I(quit-basic) \
            	{selected disabled} $I(quit-basic) \
                disabled $I(quit-basic) \
                selected $I(quit-hover) \
                pressed $I(quit-hover) \
                active $I(quit-hover) \
            ] -border 4 -sticky nsew
